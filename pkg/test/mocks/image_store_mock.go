...
func (is MockedImageStore) MountBlob(ctx context.Context, fromRepo, toRepo string, digest godigest.Digest,
) (bool, int64, error) {
	if is.MountBlobFn != nil {
		return is.MountBlobFn(ctx, fromRepo, toRepo, digest)
	}
